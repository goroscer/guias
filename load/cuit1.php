                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                            <input type="text" class="form-control" name="rs" placeholder="" value="<?=$datos->rs?>" disabled>
                                            <input type="hidden" class="form-control" name="rs1" placeholder="" value="<?=$datos->rs?>" >
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="l" value="<?=$datos->localidad?>" disabled>
                                            <input type="hidden" class="form-control" placeholder="" name="l1" value="<?=$datos->localidad?>" >
                                          </div>
                                       </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                             <input type="text" class="form-control" placeholder="" name="cp" value="<?=$datos->codigopostal?>" disabled>
                                             <input type="hidden" class="form-control" placeholder="" name="cp1" value="<?=$datos->codigopostal?>" required>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                           ...
                                           <div class="col-md-9">
                                              <input type="text" class="form-control" placeholder="" name="df" value="<?=$datos->df?>" disabled>
                                              <input type="hidden" class="form-control" placeholder="" name="df1" value="<?=$datos->df?>" required>
                                           </div>
                                        </div>
                                     </div>
