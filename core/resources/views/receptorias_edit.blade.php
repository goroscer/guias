               ...
               <div class="row">
                  ...
                  <div class="col-sm-12">
                     <div class="white-box">
                            ...
                            <center><button type="button" onclick="window.location.href = '{{ url('/receptorias') }}'" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span><a style="color:black" > Volver</a></button></center>

                        <h3 class="box-title m-b-0">Modificar Receptoría </h3>
                     <form method="POST" action="{{ url('/receptorias') }}/{{$receptoria->id}}">
                        {{ csrf_field() }}
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="c1" required value="{{ $receptoria->localidad }}">
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         <label class="control-label col-md-3">Nro</label>
                                         <div class="col-md-9">
                                            <input type="number" class="form-control" name="c2" required value="{{ $receptoria->n }}" >
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
