      ...
      <div id="wrapper">
         ...
         <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header" style="    background-color: #9ACA3C;">
               ...
               <div class="top-left-part"><a class="logo" href="{{ url('/forms') }}"><b><img src="{{ asset('images/provincia.png') }}" alt="home" style="max-width: 31px;" /></b><span class="hidden-xs"><strong>Exentos</strong>Web</span></a></div>
         ...
         <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <center><button type="button" onclick="{{ url('/forms') }}" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span><a style="color:black" > Volver</a></button></center>
               <div class="row">
                  <div class="col-sm-12">
                     <div class="white-box">
                        <h3 class="box-title m-b-0">Control - Guia {{ $form->id+6000 }}</h3>

                        <span href="#"><center><a href="{{ url('/forms/print') }}/{{$encode}}?print=true" target="_blank" class="btn btn-default" style="color:black"><span class="glyphicon glyphicon-print"></span> Imprimir</a></center></span>
