         ...
         <div id="page-wrapper">
            <div class="container-fluid">
                  ...
                  <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                     ...
                     <ol class="breadcrumb">
                        ...
                        @if($type == 'Rentas ADM' OR $type == 'WebMaster')
                                              @if($type == 'Rentas ADM' OR $type == 'WebMaster')                          <li class="active"><a href="{{ url('/users') }}">Administrar Usuarios del Sistema</a></li>                          @endif
                        @endif
                     </ol>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-12">
                     <div class="white-box">
                        <h3 class="box-title m-b-0">Aprobar</h3>
                     <form method="POST" action="{{ url('/forms') }}/approve/{{$form->id}}">
                        {{ csrf_field() }}
                        <div class="form-body">
