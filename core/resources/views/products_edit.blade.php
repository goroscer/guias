               ...
               <div class="row">
                  ...
                  <div class="col-sm-12">
                     <div class="white-box">
                            ...
                            <center><button type="button" onclick="window.location.href = '{{ url('/products') }}'" class="btn btn-default"><span class="glyphicon glyphicon-arrow-left"></span><a style="color:black" > Volver</a></button></center>

                        <h3 class="box-title m-b-0">Modificar Producto </h3>
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="c1" required value="{{ $product->name }}">
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" name="c2" required value="{{ number_format($product->price, 2, ',', '.') }}"  >
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                           <div class="form-group">
                                              ...
                                              <div class="col-md-9">
                                                 <input type="text" class="form-control" placeholder="" name="c3" required value="{{ $product->unit }}">
                                              </div>
                                           </div>
                                        </div>
                                        <!--/span-->
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         <label class="control-label col-md-3">TRS</label>
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" name="c4" required value="{{ number_format($product->trs, 2, '.', '') }}" >
                                         </div>
                                      </div>
                                   </div>
