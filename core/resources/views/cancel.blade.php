         ...
         <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="white-box">
                        <h3 class="box-title m-b-0">Rechazar</h3>
                     <form method="POST" action="{{ url('/forms') }}/cancel/{{$form->id}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-6">
                                    <div class="form-group">
                                       <label class="control-label col-md-3">N° Resolución</label>
                                       <div class="col-md-9">
                                          <input type="text" class="form-control" placeholder="" name="resolucion" value="" required>
                                       </div>
                                    </div>
                                 </div>
                                   ...
                                   <div class="col-md-6  offset-md-6">
                                      <div class="form-group">
                                         <label class="control-label col-md-3">Razón</label>
                                         <div class="col-md-9">
                                            <textarea class="form-control" placeholder="No cumple con todos los requisitos." name="comment" required></textarea>
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
