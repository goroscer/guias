...
<html lang="es">
   <head>
      ...
      <title>Guía 2.0 - Comprobante {{ $rn }} - {{ $nc }}</title>
   ...
   <body class="fix-sidebar">
      ...
      <div id="page-wrapper">
         <div class="container-fluid">
            ...
            <p style="text-align:right; z-index:1">Comprobante N°: <span style="font-size: 20px; color: blue; margin-left: 4px;">{{ $rn }} - {{ $nc }}</span></p>
                  ...
                  <div class="panel panel-info">
                     ...
                     <div class="panel-wrapper collapse in" aria-expanded="true">
                        <div class="panel-body">
                              ...
                              <p style="text-align:center; z-index:1">GUÍA ELECTRÓNICA N°: <span style="font-size: 20px; color: blue; margin-left: 4px;">{{ $form->id+6000 }}</span></p>

                              <div class="form-body">
                                 <h3 class="box-title" style="background-color: #787878; padding: 5px 15px 6px 5px; color: white;">| CONSTANCIA DE PAGO</h3>

                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label col-md-3"><strong>IMPORTE: </strong></label>${{ $form->r5 }}
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <label class="control-label col-md-3"><strong>RECEPTORIA: </strong></label>{{ $receptoria }}
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-md-12" style="margin-top: 20px; margin-bottom: 20px;">
                                       ...
                                       <div class="col-md-6">
                                          <p class="text-muted" style="font-size: 20px;    font-weight: 400; text-align:right;">Constancia impresa vía web en fecha : <span style="font-size: 20px; color: blue; margin-left: 4px;">{{ $date }}</span></p>
                                       </div>
                                    </div>
