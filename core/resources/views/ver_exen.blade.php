   ...
   <body class="fix-sidebar">
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper">
            ...
            <center>
                <button type="button" onclick="window.location.href ='{{ url('/forms_i') }}'" class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span><a style="color:black" > Guías (Receptoría: {{ $receptoria }})</a></button>
