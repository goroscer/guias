               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="white-box">
                        ...
                        <h3 class="box-title m-b-0">Modificar Usuarios </h3>
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="" name="c1" required value="{{ $user->name }}">
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="text" class="form-control" pattern="[0-9]{6,8}" placeholder="12345678" name="c2" required value="{{ $user->dni }}" >
                                         </div>
                                      </div>
                                   </div>
                                   <!--/span-->
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                           <div class="form-group">
                                              ...
                                              <div class="col-md-9">
                                                 <input type="text" class="form-control" placeholder="" name="c3" required value="{{ $user->phone }}">
                                              </div>
                                           </div>
                                        </div>
                                        <!--/span-->
                                           ...
                                           <div class="form-group">
                                              ...
                                              <div class="col-md-9">
                                                 <select class="form-control" name="c4" required>
                                                        ...
                                                        <option @if($user->office == '0') SELECTED @endif value="0">RENTAS</option>
                                                        @foreach($receptorias as $receptoria)

                                                            <option @if($user->office == $receptoria->id) SELECTED @endif value="{{ $receptoria->id }}">{{ $receptoria->localidad.' - '.$receptoria->n }}</option>
                                ...
                                <div class="row">
                                      ...
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <select class="form-control" name="c5" required>
                                               <option value="">Selecione una</option>                                 
                                               <option @if($user->type == 'WebMaster') SELECTED @endif value="WebMaster">WebMaster</option>
                                               <option @if($user->type == 'Rentas ADM') SELECTED @endif value="Rentas ADM">Rentas ADM</option>
                                               <option @if($user->type == 'Rentas Común') SELECTED @endif value="Rentas Común">Rentas Común</option>
                                               <option @if($user->type == 'Receptorías') SELECTED @endif value="Receptorías">Receptorías</option>

                                               <option @if($user->type == 'Ruta') SELECTED @endif value="Ruta">Ruta</option>
                                   ...
                                   <div class="col-md-6">
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-9">
                                            <input type="email" class="form-control" placeholder="" name="c6" required value="{{ $user->email }}">
                                         </div>
                                      </div>
                                   </div>
                                </div>
                                   ...
                                   <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                             <input type="text" class="form-control" placeholder="" name="c7" required value="{{ $user->username }}">
                                          </div>
                                       </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="col-md-9">
                                             <input type="password" class="form-control" placeholder="" name="c8" required value="{{ $user->password }}">
                                          </div>
                                       </div>
                                    </div>
                                    <!--/span-->
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                           <select class="form-control" name="c9" required>                                            
                                              <option @if($user->estatus == 'Activo') SELECTED @endif>Activo</option>
                                              <option @if($user->estatus == 'Desactivado') SELECTED @endif>Desactivado</option>
                                              <option @if($user->estatus == 'Activo sin pases') SELECTED @endif>Activo sin pases</option>
                                           </select>
                                        </div>
                                     </div>
                                  </div>
