         ...
         <div id="page-wrapper">
            <div class="container-fluid">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <div class="white-box">
                        <h3 class="box-title m-b-0">Listado de Receptorias </h3>
                        
                        <center><button type="button" onclick="window.location.href ='{{ url('/receptorias/create') }}'" class="btn btn-default"><span class="glyphicon glyphicon-plus"></span><a style="color:black" > Añadir</a></button></center>
                           ...
                           <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                        ...
                                        <td>{{ $receptoria->localidad }}</td>

                                        <td>{{ $receptoria->n }}</td>

                                        <td>
                                            
                                            <button type="button" onclick="window.location.href = '{{ url('receptorias') }}/{{$receptoria->id}}/edit'" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="Editar Datos"><i class="ti-settings" aria-hidden="true"></i></button>

                                            <a onclick="confirmDelete({{$receptoria->id}})"> <span style="color: grey;" class="glyphicon glyphicon-trash" title="Delete"></a>
                    ...
                    cancelButtonText: 'Cancelar'
                     ...
                     if (result.value) {
                         $.ajax({
                             ...
                             type: "DELETE",
                             url: '{{ url('receptorias') }}/'+id,
                             success: function(affectedRows) {
 
                                 if (affectedRows > 0) window.location = "{{ url('receptorias') }}";
                             }
                         });
                     }
