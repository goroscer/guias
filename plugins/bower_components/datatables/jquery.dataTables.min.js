...
wa(a,b);a.bAjaxDataGet=!0;C(a,!1)}function va(a,b){var c=h.isPlainObject(a.ajax)&&a.ajax.dataSrc!==k?a.ajax.dataSrc:a.sAjaxDataProp;return"data"===c?b.aaData||b[c]:""!==c?R(c)(b):b}function rb(a){var b=a.oClasses,c=a.sTableId,d=a.oLanguage,e=a.oPreviousSearch,f=a.aanFeatures,g='<input type="seaArch" class="'+b.sFilterInput+'"/>',j=d.sSearch,j=j.match(/_INPUT_/)?j.replace("_INPUT_",g):j+g,b=h("<div/>",{id:!f.f?c+"_filter":null,"class":b.sFilter}).append(h("<label/>").append(j)),f=function(){var b=!this.value?
...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"¡Felicitaciones no tienes solicitudes pendientes!",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ filas",sInfoEmpty:"Mostrando 0 de 0 de 0 filas",sInfoFiltered:"(filtrado desde _MAX_ total de filas)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrando _MENU_ entradas",sLoadingRecords:"Cargando...",sProcessing:"Processing...",sSearch:"Buscar Palabra Clave:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No se encontraron registros"},
